...
contract TestAprLinkHook_ForkAug2024 is Test, Deployers {
    ...
    function setUp() public {
        vm.createSelectFork(vm.rpcUrl("sepolia"), 6498337); // 14 Aug 2024
    ...
    function test_feeUpdatesWithGasPrice() public {
        ...
        assertEq(swapDelta.amount0(), -1000327108);
